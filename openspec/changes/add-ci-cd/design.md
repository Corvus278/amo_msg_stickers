...
`--latest=false`, а следующий шаг ставит «Latest» (на него ведёт README) наибольшему по `sort -V` тегу: последний
завершившийся прогон видит все теги и ставит верный.
